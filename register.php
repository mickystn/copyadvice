...
<body>
    ...
    <div class="user-login-box " style="max-width: 500px; margin: auto;">
        <div class="container-form" >
            <form class= "form-reg"action="register_db.php" method="post" >
                ...
                <div class="user-details text-left">
                    ...
                    <div class="input-box">
                        ...
                        <input type="address" name="address" placeholder="ที่อยู่" required>
                    </div>
                    <div class="input-box">
                        <span class="details">Birth Date</span>
                        <input type="date"  name="bd"placeholder="วันเกิด" required>
                    </div>
                    <div class="input-box">
                ...
                <button class="btn-reg text-left" name="reg_user">Register</button>
            </form>
        </div>
    </div>
</body>
