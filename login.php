...
<body>
    ...
    <form class="form-login"action="login_db.php" method="post" style="margin: auto">
        <div class="container">
            <div class="col-12 col-md-6 wrapper .container">
                        ...
                        <?php if(isset($_SESSION['error'])) :?>
                            <div class="error">
                                ...
                                <script type='text/javascript'>alert('กรุณาตรวจสอบอีเมลและรหัสผ่าน');</script>
                            </div>
                        <?php endif?>
                        <div class="col-12 text-left mb-3">
                            <h1 class="mb-0">เข้าสู่ระบบ</h1>
                            <b>ยินดีต้อนรับเข้าสู่ระบบลูกค้า Advice ทุกท่าน</b>
                        </div>
                        <div class="col-12 text-left mb-3">
                            <b>Email</b>
                        ...
                        <div class="col-12 text-left">
                            <a href="register.php">สมัครสมาชิก</a>
                            <button name="login_user" class="btn-login text-left">Login</button>
                        </div>
                </div>
            </div>
        </div>
